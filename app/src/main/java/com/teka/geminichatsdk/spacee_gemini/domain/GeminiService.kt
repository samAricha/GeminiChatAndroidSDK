...
import com.teka.geminichatsdk.spacee_gemini.data.dto.Request
import com.teka.geminichatsdk.spacee_gemini.data.dto.Response
...
class GeminiService {
    ...
    private var apiKey: String = BuildConfig.GEMINI_KEY
